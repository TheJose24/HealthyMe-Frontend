  ...
  template: `
    <header class="flex items-center justify-between bg-gradient-healthyme px-6 py-3 text-white">
      <div class="flex items-center gap-2">
        <mat-icon fontIcon="history" class="align-middle text-[22px] leading-none"></mat-icon>
      ...
      <button type="button" mat-icon-button (click)="ref.close()">
        <mat-icon fontIcon="close" class="text-white"></mat-icon>
      </button>
    </header>
              ...
              <mat-accordion>
                ...
                >
                  <mat-expansion-panel-header class="!justify-center !bg-white">
                    ...
                    >
                      <mat-icon fontIcon="description" class="text-primary"></mat-icon>
                      Receta #{{ i + 1 }}
                    </span>
